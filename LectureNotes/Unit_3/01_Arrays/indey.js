...
numArray.forEach(function (number) {
  // Concise Body If/Else If Statement
  if (number % 15 === 0)
...
/* for (let x = 1; x < 101; x++) {
  ...
  if (x % 3 === 0 && x % 5 === 0) {
    fizzBuzzArray[x-1] += "FizzBuzz";
  } else if(x % 3 === 0) {
    fizzBuzzArray[x-1] += "Fizz";
  } else if (x % 5 === 0) {
    fizzBuzzArray[x-1] += "Buzz";
  }
  ...
  // console.log('current index:', numArray[x-1]);
  // console.log('current FB:', fizzBuzzArray[x-1]);
}
console.log(fizzBuzzArray); */

// concise body for loop
// for (let x = 1; x < 101; x++) numArray.push(x);
